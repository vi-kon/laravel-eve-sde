...
class SolarSystem extends Model {
    ...
    public function solarSystemJumpsFrom() {
        return $this->belongsTo('ViKon\EveSDE\Models\Map\SolarSystemJumps', 'solar_system_id', 'from_solar_system_id');
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo
     */
    public function solarSystemJumpsTp() {
        return $this->belongsTo('ViKon\EveSDE\Models\Map\SolarSystemJumps', 'solar_system_id', 'to_solar_system_id');
    }
